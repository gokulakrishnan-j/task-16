                        ...
                        <div className="card-body">
                            ...
                            <div className="progress">
                                <div className="progress-bar bg-success" role="progressbar" style={{"width": "100%",
                                   " ariaValueno":"100", "ariaValuemn":"0", "ariaValuemax":"100"}}></div>
                            </div>
                        </div>
                    </div>
                   ...
                   {/* <!-- Illustrations -->*/}
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <p>Add some quality, svg illustrations to your project courtesy of <div
                                    target="blank" rel="nofollow" >unDraw</div>, a
                                constantly updated collection of beautiful svg images that you can use
                                completely free and without attribution!</p>
                            <div target="blank" rel="nofollow" >Browse Illustrations on
                                unDraw &rarr;</div>
                        </div>
                    </div>
